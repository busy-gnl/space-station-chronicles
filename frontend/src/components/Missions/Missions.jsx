...
export default function Missions() {
  ...
  function nextMission() {
    const newIndex = missions.indexOf(mission) + 1;
    setMission(missions[newIndex]);
    console.info("mission :>> ", mission);
  }

  return (
    <div className="missions-container">
      <div className="mission-info">
        <strong className="missions-domain">{mission.domain}</strong> <br />
        {mission.description}
      </div>
      <button
        className="missions-next-button"
        type="button"
        onClick={() => nextMission()}
      >
        Next
